...
import sys
sys.path.append(r'C:\Users\kpk16\OneDrive\Desktop\recreate1')  # Add the directory containing aggregators.py to sys.path

import aggregators  # Import the aggregators module
import truncate # Import the truncate module
from  aggregators import mean, median, trimmed_mean
from truncate import find_U
